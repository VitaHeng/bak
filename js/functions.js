...
function timeElapse(c) {
    ...
    if (f < 10) { f = "0" + f }
    var a = '<span class="digit">' + g + '</span> <span id=\"anglia\">days</span> <span class="digit">' + b + '</span> <span id=\"anglia\">hours</span> <span class="digit">' + d + '</span> <span id=\"anglia\">minutes</span> <span class="digit">' + f + "</span> <span id=\"anglia\">seconds</span>";
    $("#elapseClock").html(a)
}
